...
export const CHANGING_CONVERSATION_STATUS = 'CHANGING_CONVERSATION_STATUS';
export const CHANGED_CONVERSATION_STATUS = 'CHANGED_CONVERSATION_STATUS';
...
export const GET_ALL_CUSTOM_ATTRIBUTES = 'GET_ALL_CUSTOM_ATTRIBUTES';
export const GET_ALL_CUSTOM_ATTRIBUTES_SUCCESS = 'GET_ALL_CUSTOM_ATTRIBUTES_SUCCESS';
export const GET_ALL_CUSTOM_ATTRIBUTES_ERROR = 'GET_ALL_CUSTOM_ATTRIBUTES_ERROR';

export const GET_ALL_LABELS = 'GET_ALL_LABELS';
export const GET_ALL_LABELS_SUCCESS = 'GET_ALL_LABELS_SUCCESS';
export const GET_ALL_LABELS_ERROR = 'GET_ALL_LABELS_ERROR';

export const GET_CONVERSATION_LABELS = 'GET_CONVERSATION_LABELS';
export const UPDATE_CONVERSATION_LABELS_SUCCESS = 'UPDATE_CONVERSATION_LABELS_SUCCESS';
export const GET_CONVERSATION_LABELS_SUCCESS = 'GET_CONVERSATION_LABELS_SUCCESS';
export const GET_CONVERSATION_LABELS_ERROR = 'GET_CONVERSATION_LABELS_ERROR';
...
export const GET_CONTACT_CONVERSATIONS_ERROR = 'GET_CONTACT_CONVERSATIONS_ERROR';
