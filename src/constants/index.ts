...
// [conomni] m4: имена языков — эндонимы (каждый язык на своём наречии), а не английские
// названия; так делают большинство language picker'ов и это не зависит от текущей локали
// приложения (раньше все 33 пункта, включая "Russian", были захардкожены по-английски).
